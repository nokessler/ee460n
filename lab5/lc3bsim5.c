...
void latch_datapath_values() {
   ...
   if (GetLD_TRANS(CURRENT_LATCHES.MICROINSTRUCTION)) {
      ...
      switch (GetRSMUX(CURRENT_LATCHES.MICROINSTRUCTION)) {
         case 0: NEXT_LATCHES.RS = 23; break;
         case 1: NEXT_LATCHES.RS = 24; break;
         case 2: NEXT_LATCHES.RS = 25; break;
         case 3: NEXT_LATCHES.RS = 28; break;
         case 4: NEXT_LATCHES.RS = 29; break;
         case 5: NEXT_LATCHES.RS = 33; break;
         case 6: NEXT_LATCHES.RS = 36; break;
         case 7: NEXT_LATCHES.RS = 37; break;
         case 8: NEXT_LATCHES.RS = 48; break;
         case 9: NEXT_LATCHES.RS = 49; break;
         case 10: NEXT_LATCHES.RS = 55; break;
      }
   }
